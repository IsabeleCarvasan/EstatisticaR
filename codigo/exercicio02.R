dados <- read.csv("/home/isabelecarvasan/Desktop/EstatisticaR-master/dados/exercicio2.csv", sep=";", dec=",",header=TRUE);
...
#//medidas de dispersão: diferença entre o maior e menor valor dos dados
